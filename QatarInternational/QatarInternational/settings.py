"""
Django settings for QatarInternational project.
...
SECRET_KEY = 'django-insecure-lkcj9h*&6@&)@g@2k1ji$w9&+t4ono3esh(qidp5)g6gji2*-y'
...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    '0a4d-103-129-215-5.ngrok-free.app',
]

# settings.py

CSRF_TRUSTED_ORIGINS = [
    "https://0a4d-103-129-215-5.ngrok-free.app",
]
...
ROOT_URLCONF = 'QatarInternational.urls'
...
WSGI_APPLICATION = 'QatarInternational.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'qatar_db',         # your MySQL DB name
